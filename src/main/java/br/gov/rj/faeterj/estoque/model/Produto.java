...
import br.gov.rj.faeterj.estoque.validation.SKU;
...
public class Produto {
	...
	@Size(max = 100, message = "O tamanho da descrição deve estar entre 1 e 100 caracteres")
	private String descricao;
	
	@NotNull(message = "Valor é obrigatório")
	@DecimalMin(value = "0.50", message = "O valor do produto deve ser maior que R$0,50")
	@DecimalMax(value = "9999999.99", 
	            message = "O valor do produto deve ser menor que R$9.999.999,99")
